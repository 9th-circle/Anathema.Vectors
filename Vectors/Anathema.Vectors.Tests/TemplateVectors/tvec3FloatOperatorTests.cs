...
{
    public class tvec3FloatOperatorTests
    {
        [Fact]
        ...
        {
            tvec3<float> a = new tvec3<float>(1, 2, 3);
            tvec3<float> b = new tvec3<float>(1, 2, 3);
            tvec3<float> c = new tvec3<float>(3, 4, 5);
            tvec3<float> n = null;
            tvec3<float> n2 = null;
            Assert.True(a == b);
            Assert.False(a == c);
        ...
        public void tvec3Addition(float x1, float y1, float z1, float x2, float y2, float z2)
        {
            tvec3<float> a = new tvec3<float>(x1, y1, z1);
            tvec3<float> b = new tvec3<float>(x2, y2, z2);
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 15.23f, 20.99999999999f, 0.01f, 10 })]
        [InlineData(new object[] { -37, 0, 2, -5, -3, -2 })]
        public void tvec3Subtraction(float x1, float y1, float z1, float x2, float y2, float z2)
        {
            tvec3<float> a = new tvec3<float>(x1, y1, z1);
            tvec3<float> b = new tvec3<float>(x2, y2, z2);
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 15.23f, 20.99999999999f, 0.01f, 10 })]
        [InlineData(new object[] { -37, 0, 2, -5, -3, -2 })]
        public void tvec3Multiplication(float x1, float y1, float z1, float x2, float y2, float z2)
        {
            tvec3<float> a = new tvec3<float>(x1, y1, z1);
            tvec3<float> b = new tvec3<float>(x2, y2, z2);
            tvec3<float> c = a * b;
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 15.23f, 20.99999999999f, 0.01f, 10 })]
        [InlineData(new object[] { -37, 0, 2, -5, -3, -2 })]
        public void tvec3MutatorMultiplication(float x1, float y1, float z1, float x2, float y2, float z2)
        {
            tvec3<float> a = new tvec3<float>(x1, y1, z1);
            tvec3<float> b = new tvec3<float>(x2, y2, z2);
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 15.23f, 20.99999999999f, 0.01f, 10 })]
        [InlineData(new object[] { -37, 0, 2, -5, -3, -2 })]
        public void tvec3Division(float x1, float y1, float z1, float x2, float y2, float z2)
        {
            tvec3<float> a = new tvec3<float>(x1, y1, z1);
            tvec3<float> b = new tvec3<float>(x2, y2, z2);
        ...
        public void scalarMultiplication(float x, float y, float z, float scalar)
        {
            tvec3<float> a = new tvec3<float>(x, y, z);

            tvec3<float> c = a * scalar;
            tvec3<float> d = scalar * a;
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 20.99999999999f, 2 })]
        [InlineData(new object[] { -37, 0, 2, 1 })]
        public void scalarDivision(float x, float y, float z, float scalar)
        {
            tvec3<float> a = new tvec3<float>(x, y, z);
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 20.99999999999f, 2 })]
        [InlineData(new object[] { -37, 0, 2, 1 })]
        public void scalarAddition(float x, float y, float z, float scalar)
        {
            tvec3<float> a = new tvec3<float>(x, y, z);
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, 20.99999999999f, 2 })]
        [InlineData(new object[] { -37, 0, 2, 1 })]
        public void scalarSubtraction(float x, float y, float z,float scalar)
        {
            tvec3<float> a = new tvec3<float>(x, y, z);
