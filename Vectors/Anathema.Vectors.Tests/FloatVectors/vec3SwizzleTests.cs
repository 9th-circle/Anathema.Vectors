...
namespace Anathema.Vectors.Tests.FloatVectors
{
    public class vec3SwizzleTests
    {
        ...
        [Theory]
        [InlineData(new object[] { 1, 2, 3 })]
        [InlineData(new object[] { 5.2f, 10.00001f, -3.7f })]
        [InlineData(new object[] { -37, 0, 42 })]
        public void duplicateSwizzles_ALL(float x1, float y1, float z1)
        {
            vec3 a = new vec3(x1, y1, z1);
        ...
        [InlineData(new object[] { 5.2f, 10.00001f, -3.7f })]
        [InlineData(new object[] { -37, 0, 42 })]
        public void duplicateColourSwizzles_ALL(float x1, float y1, float z1)
        {
            vec3 a = new vec3(x1, y1, z1);
