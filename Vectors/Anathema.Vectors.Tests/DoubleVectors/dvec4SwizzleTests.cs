...
{
    public class dvec4SwizzleTests
    {
        ...
        public void swizzleWrites()
        {
            ...
            a.xyzw = new dvec4(4, 5, 6, 7);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.xywz = new dvec4(4, 5, 7, 6);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.xzyw = new dvec4(4, 6, 5, 7);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.xzwy = new dvec4(4, 6, 7, 5);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.xwzy = new dvec4(4, 7, 6, 5);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.xwyz = new dvec4(4, 7, 5, 6);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);
            ...
            a.wxyz = new dvec4(7, 4, 5, 6);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.wxzy = new dvec4(7, 4, 6, 5);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.wyxz = new dvec4(7, 5, 4, 6);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.wyzx = new dvec4(7, 5, 6, 4);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.wzyx = new dvec4(7, 6, 5, 4);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.wzxy = new dvec4(7, 6, 4, 5);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);
            ...
            a.zxyw = new dvec4(6, 4, 5, 7);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.zxwy = new dvec4(6, 4, 7, 5);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.zwxy = new dvec4(6, 7, 4, 5);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.zwyx = new dvec4(6, 7, 5, 4);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.zywx = new dvec4(6, 5, 7, 4);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.zyxw = new dvec4(6, 5, 4, 7);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);
            ...
            a.yzxw = new dvec4(5, 6, 4, 7);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.yxwz = new dvec4(5, 4, 7, 6);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);
            ...
            a.yzwx = new dvec4(5, 6, 7, 4);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.ywzx = new dvec4(5, 7, 6, 4);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.ywxz = new dvec4(5, 7, 4, 6);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);

            a.yxzw = new dvec4(5, 4, 6, 7);
            Assert.Equal(4, a.x);
            Assert.Equal(5, a.y);
            Assert.Equal(6, a.z);
            Assert.Equal(7, a.w);
        ...
        public void colourSwizzleWrites()
        {
            ...
            a.rgba = new dvec4(4, 5, 6, 7);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.rgab = new dvec4(4, 5, 7, 6);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.rbga = new dvec4(4, 6, 5, 7);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.rbag = new dvec4(4, 6, 7, 5);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.rabg = new dvec4(4, 7, 6, 5);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.ragb = new dvec4(4, 7, 5, 6);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);
            ...
            a.argb = new dvec4(7, 4, 5, 6);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.arbg = new dvec4(7, 4, 6, 5);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.agrb = new dvec4(7, 5, 4, 6);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.agbr = new dvec4(7, 5, 6, 4);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.abgr = new dvec4(7, 6, 5, 4);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.abrg = new dvec4(7, 6, 4, 5);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);
            ...
            a.brga = new dvec4(6, 4, 5, 7);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.brag = new dvec4(6, 4, 7, 5);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.barg = new dvec4(6, 7, 4, 5);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.bagr = new dvec4(6, 7, 5, 4);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.bgar = new dvec4(6, 5, 7, 4);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.bgra = new dvec4(6, 5, 4, 7);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);
            ...
            a.gbra = new dvec4(5, 6, 4, 7);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.grab = new dvec4(5, 4, 7, 6);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);
            ...
            a.gbar = new dvec4(5, 6, 7, 4);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.gabr = new dvec4(5, 7, 6, 4);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.garb = new dvec4(5, 7, 4, 6);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);

            a.grba = new dvec4(5, 4, 6, 7);
            Assert.Equal(4, a.r);
            Assert.Equal(5, a.g);
            Assert.Equal(6, a.b);
            Assert.Equal(7, a.a);
